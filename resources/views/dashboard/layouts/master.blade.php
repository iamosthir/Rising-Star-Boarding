        ...
        <div class="side-menu" id="mobileMenu">
            ...
            <div class="menu text-center mt-4">
                ...
                <ul class="mobile-menu-item">
                    ...
                    <li><a href="/contact-us" data-nav-custom="none" ><i class="fas fa-paw me-2"></i> Contact Us</a></li>
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu drop-menu-mobile" aria-labelledby="navbarDropdown">
                            <li><router-link class="dropdown-item" :to="{name: 'home'}"><i class="fas fa-user"></i> &nbsp; Dashboard</router-link></li>
                            <li><router-link  class="dropdown-item" :to="{name: 'booking-history'}"><i class="fas fa-clock"></i> &nbsp; My Bookings</router-link></li>
                            <li><router-link class="dropdown-item" :to="{name: 'home.reservation'}"><i class="fas fa-plus"></i> &nbsp; Start new booking</router-link>
                            </li>
                            <li>
            ...
            <nav class="navbar navbar-expand navbar-light top-nav">
                <div class="container">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 top-menu-nav">
                        <li class="nav-item">
                            <a data-nav-custom="none" class="nav-link" aria-current="page" href="/"><i class="fas fa-paw me-2"></i> Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a data-nav-custom="none" class="nav-link" aria-current="page" href="/contact-us"><i class="fas fa-paw me-2"></i> Contact Us</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu drop-menu" aria-labelledby="navbarDropdown">
                                <li><router-link class="dropdown-item" :to="{name: 'home'}"><i class="fas fa-user"></i> &nbsp; Dashboard</router-link></li>
                                <li><router-link class="dropdown-item" :to="{name: 'booking-history'}"><i class="fas fa-clock"></i> &nbsp; My Bookings</router-link></li>
                                <li><router-link :to="{name: 'home.reservation'}" class="dropdown-item"><i class="fas fa-plus"></i> &nbsp; Start new booking</router-link>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
